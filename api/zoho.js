...
const REPORTS = {
  ...
  Measurement_Units: "All_Measurement_Units",
...
const FIELD_MAPS = {
  ...
  Measurement_Units: (d) => ({
    ...
    Oz_Equivalent: parseFloat(d.oz_equivalent || 0),
  ...
  Recipe_Ingredients: (d) => ({
    ...
    Quantity_Per_Plate: d.quantity_per_plate || "",
    Portion_Cost: parseFloat(parseFloat(d.portion_cost || 0).toFixed(4)),
    Quantity_Unit: d.quantity_unit || "",
    Quantity_Amount: parseFloat(d.quantity_amount || 0),
  }),
  PAR_Entries: (d) => ({
    Ingredient_Name: d.ingredient_name || "",
    Ingredient_ID: d.ingredient_id || "",
